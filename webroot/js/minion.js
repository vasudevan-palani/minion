...
(function($) {
    ...
    function getTemplate(timeIcon, pickDate, pickTime, is12Hours, showSeconds, collapse) {
        if (pickDate && pickTime) {
            return '<div class="bootstrap-datetimepicker-widget dropdown-menu">' + '<div class="datepicker collapse in picker">' + DPGlobal.template + "</div>" + '<div class="text-center"><a href="#" data-toggle="collapse" data-target=".picker"><i class="glyphicon glyphicon-time"></i></a></div>' + '<div class="timepicker collapse picker">' + TPGlobal.getTemplate(is12Hours, showSeconds) + "</div>" + "</div>"
        } else if (pickTime) {
...
minionModule.directive('ninjaPanel',function()
 {
    return {
        restrict : 'E',
        scope : {title:'=',close:'&'},
...
minionModule.directive('ninjaCalendar',function()
 {
    return {
        require : 'ngModel',
            ...
            if(!angular.isUndefined(attrs.pasteFormat))
            {
                $(element).find('input').on('paste', function () {
                  ...
                  setTimeout(function()
                  {
                    ...
                    {
                        $(e).val(date1.toString("yyyy-MM-dd"));
                        $(e).trigger('change');                    
                    }
                    else
                    {
                        $(e).val(date1.toString("yyyy-MM-dd HH:mm:ss"));
                        $(e).trigger('change');                    
                    }
                  },100)
                });
...
minionModule.directive('ninjaIcon',function()
 {
    return {
        ...
        link: function(scope,elm,attrs)
        {
            if(attrs.ninjaBtn != "")
            {
                $(elm).prepend("<span class='glyphicon glyphicon-"+attrs.ninjaIcon+"'></span> ");
...
minionModule.directive('ninjaBtn',function()
 {
    return {
        ...
        link: function(scope,elm,attrs)
        {
            if(attrs.ninjaBtn != "")
            {
                $(elm).prepend("<span class='glyphicon glyphicon-"+attrs.ninjaBtn+"'></span> ");
...
minionModule.service('$ninjaUtils',function($rootScope,$sce,$http)
{
    ...
    this.ajaxCall = function(url, data, successFunction, errorFunction, silent) {
...
minionModule.directive('typeahead', function($timeout,$http,$ninjaUtils,$rootScope) {
  ...
  return {
    ...
    link: function(scope, elem, attrs) {
      ...
      scope.da  = function(txt){
          ...
          if((!angular.isUndefined(scope.modeldisplay)) && scope.modeldisplay != "")
          {
            $ninjaUtils.ajaxCall('/Ninja/rest/metric/auto',
                {
      ...
      scope.handleSelection = function(item) {
        scope.modelret = item.serverName+"/"+item.pluginName+"/"+item.metricName;
        ...
        scope.modeldisplay = item.serverName+"/"+item.pluginName+"/"+item.metricName;
        scope.searchtag = item.serverName+"%"+item.pluginName+"%"+item.metricName;
        scope.current = 0;
        scope.selected = true;
      }
...
minionModule.controller('LoginController',function($scope,$rootScope,$ninjaUtils)
{
    $scope.data={};

    $scope.login = function()
    {
        $ninjaUtils.ajaxCall('/minion/users/doLogin.json',$scope.data,function(data)
        {
...
minionModule.controller('NavController',function($scope,$rootScope,$ninjaUtils,$log)
{
    $scope.data={};
    $rootScope.selects={};
    $scope.init = function(){
    ...
    $rootScope.getList=function(items,refresh){
        var results={};
        if(refresh){
            $ninjaUtils.ajaxCall('/minion/selects/index.json',{'items':items},function(data){
...
minionModule.controller('ProjectsController',function($scope,$rootScope,$ninjaUtils)
{
    $scope.data={};
    ...
    $scope.search = function(){
        $ninjaUtils.ajaxCall('/minion/projects/search.json',$scope.data,function(data)
        {
...
minionModule.controller('EffortsController',function($scope,$rootScope,$ninjaUtils)
{
    $scope.add={data:{}};
    $scope.search={data:{}};
    $scope.edit={data:{}};
    ...
    $scope.add.save = function(){
        $ninjaUtils.ajaxCall('/minion/efforts/add.json',$scope.add.data,function(data)
        {
    ...
    $scope.search.submit = function(){
        $ninjaUtils.ajaxCall('/minion/efforts/search.json',$scope.search.data,function(data)
        {
            $scope.results = data.data;
        });
    }
...
minionModule.controller('AlertController',function($scope,$rootScope,$ninjaUtils)
{
    $scope.data={};
...
minionModule.controller('InvoicesController',function($scope,$rootScope,$ninjaUtils,$log)
{
    $scope.data={};
    ...
    $scope.search = function(){
        $ninjaUtils.ajaxCall('/minion/invoices/search.json',$scope.data,function(data)
        {
            $scope.results = data.data;
        });
    }
    ...
    $scope.add = function(){
        $ninjaUtils.ajaxCall('/minion/invoices/add.json',$scope.data,function(data)
        {
            $scope.results = data.data;
        });
    }
    ...
    $scope.selectPO = function(po){
        ...
        $ninjaUtils.ajaxCall('/minion/purchaseOrders/get.json',{'id':$scope.selectedPO.id},function(data)
        {
            $scope.data.invoice_users = data.data[0].po_users;
        });
        $ninjaUtils.ajaxCall('/minion/invoices/getTotalInvoicesByPo.json',{'po_id':$scope.selectedPO.id},function(data)
        {
...
minionModule.controller('UsersController',function($scope,$rootScope,$ninjaUtils)
{
    $scope.data={};
    ...
    $scope.addUser = function(){
        $ninjaUtils.ajaxCall('/minion/users/add.json',$scope.data,function(data)
        {
    ...
    $scope.searchUser = function(){
        $ninjaUtils.ajaxCall('/minion/users/search.json',$scope.search.data,function(data)
        {
            $scope.results = data.data;
        });
    }
...
minionModule.controller('PurchaseOrdersController',function($scope,$rootScope,$ninjaUtils)
{
    $scope.data={};
    ...
    $scope.search = function(){
        $ninjaUtils.ajaxCall('/minion/purchaseOrders/search.json',{'po_number':$scope.search.po_number},function(data)
        {
    ...
    $scope.addPO = function(){
        $ninjaUtils.ajaxCall('/minion/purchaseOrders/add.json',$scope.data,function(data)
        {
            $scope.results = data.data;
        });
    }
    ...
    $scope.update = function(){
        $ninjaUtils.ajaxCall('/minion/purchaseOrders/update.json',$scope.edit.data,function(data)
        {
        });
    }
});

minionModule.controller('NavBarController',function($scope,$rootScope,$ninjaUtils)
{
    $scope.data={};
